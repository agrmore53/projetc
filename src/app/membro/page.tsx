...
export default function MembroPage() {
  ...
  const materiais = [
    ...
    { icon: Calendar, title: 'Calendario Editorial', desc: 'Planeje seu conteudo mensal', status: 'available', link: '/membro/calendario-editorial', highlight: true },
    { icon: BarChart2, title: 'Calculadora CPM/CPC/CPA', desc: 'Metricas de anuncios digitais', status: 'available', link: '/membro/cpm-cpc-cpa', highlight: true },
    { icon: FileText, title: 'Gerador de Briefing', desc: 'Briefings para campanhas de marketing', status: 'available', link: '/membro/briefing', highlight: true },
    { icon: Coins, title: 'Calculadora ROAS', desc: 'Retorno sobre investimento em ads', status: 'available', link: '/membro/roas', highlight: true },
    { icon: Grid3X3, title: 'Matriz de Conteudo', desc: 'Conteudo por funil e canal', status: 'available', link: '/membro/matriz-conteudo', highlight: true },
    { icon: MessageSquare, title: 'Gerador de Copy Social', desc: 'Copys para redes sociais', status: 'available', link: '/membro/copy-social', highlight: true },
    { icon: FileBarChart, title: 'Gerador de DRE', desc: 'Demonstrativo de Resultados', status: 'available', link: '/membro/dre', highlight: true },
    { icon: Wallet, title: 'Projecao Fluxo de Caixa', desc: 'Projete entradas e saidas', status: 'available', link: '/membro/fluxo-caixa', highlight: true },
    { icon: Percent, title: 'Calculadora de Markup', desc: 'Precificacao com margem desejada', status: 'available', link: '/membro/markup', highlight: true },
    { icon: Receipt, title: 'Orcamento Anual', desc: 'Planejamento orcamentario anual', status: 'available', link: '/membro/orcamento-anual', highlight: true },
    { icon: DollarSign, title: 'Calculadora Payroll', desc: 'Folha de pagamento completa', status: 'available', link: '/membro/payroll', highlight: true },
    { icon: Package, title: 'Gerador de PRD', desc: 'Product Requirements Document', status: 'available', link: '/membro/prd', highlight: true },
    { icon: Grid3X3, title: 'Matriz de Features', desc: 'Priorize features por impacto', status: 'available', link: '/membro/matriz-features', highlight: true },
    { icon: FileText, title: 'Gerador de Changelog', desc: 'Documentacao de releases', status: 'available', link: '/membro/changelog', highlight: true },
    { icon: Tag, title: 'Calculadora de Pricing', desc: 'Monte tabela de precos', status: 'available', link: '/membro/pricing', highlight: true },
    { icon: Bug, title: 'Template Bug Report', desc: 'Reporte bugs estruturadamente', status: 'available', link: '/membro/bug-report', highlight: true },
    { icon: Presentation, title: 'Template QBR', desc: 'Quarterly Business Review', status: 'available', link: '/membro/qbr', highlight: true },
    { icon: RefreshCw, title: 'Playbook Reativacao', desc: 'Recupere clientes inativos', status: 'available', link: '/membro/reativacao', highlight: true },
    { icon: Target, title: 'Success Plan', desc: 'Plano de sucesso do cliente', status: 'available', link: '/membro/success-plan', highlight: true },
    { icon: TrendingDown, title: 'Churn Prediction', desc: 'Preveja risco de cancelamento', status: 'available', link: '/membro/churn-prediction', highlight: true },
    { icon: Shield, title: 'Gerador de NDA', desc: 'Acordo de confidencialidade', status: 'available', link: '/membro/nda', highlight: true },
    { icon: FileText, title: 'Contrato de Servico', desc: 'Template de contrato de servicos', status: 'available', link: '/membro/contrato-servico', highlight: true },
    { icon: ClipboardList, title: 'Gerador de SLA', desc: 'Service Level Agreement', status: 'available', link: '/membro/sla', highlight: true },
    { icon: Users, title: 'Feedback 360', desc: 'Avaliacao de multiplas fontes', status: 'available', link: '/membro/feedback-360', highlight: true },
    { icon: TrendingUp, title: 'Plano de Carreira', desc: 'Desenvolvimento profissional', status: 'available', link: '/membro/plano-carreira', highlight: true },
    { icon: ClipboardCheck, title: 'Avaliacao Desempenho', desc: 'Performance review estruturada', status: 'available', link: '/membro/avaliacao-desempenho', highlight: true },
    { icon: Calculator, title: 'Custo de Funcionario', desc: 'Calcule custo total CLT', status: 'available', link: '/membro/custo-funcionario', highlight: true },
    { icon: FileWarning, title: 'Template Postmortem', desc: 'Analise de incidentes blameless', status: 'available', link: '/membro/postmortem', highlight: true },
    { icon: CheckSquare, title: 'Checklist Customizavel', desc: 'Crie e gerencie checklists', status: 'available', link: '/membro/checklist-custom', highlight: true },
    { icon: Activity, title: 'Status Page Generator', desc: 'Paginas de status de servicos', status: 'available', link: '/membro/status-page', highlight: true },
  ]
